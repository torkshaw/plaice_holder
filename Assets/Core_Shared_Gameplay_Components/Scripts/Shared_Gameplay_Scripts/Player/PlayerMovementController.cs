...
public class PlayerMovementController : MonoBehaviour
{
    ...
    [SerializeField] private float coyoteTime = 0.1f; // how long the player can jump when they have left a surface
    ...
    private void HandleHorizontalMovement() // this is the actual movement function
    {
        ...
        float accelRate = moveInput != 0 ? acceleration : deceleration; // here we're creating the accelRate variable but it is going to be both accel an decel, in practice-
